...
| **`source_file`**                          | `README.md`  | Repo-relative path: **code** pane.                                                                                                       |
| **`commentray_markdown`**                  | empty        | Repo-relative path: **commentray** pane (falls back to conventional **`.commentray/source/{source_file}.md`** in some tools when unset). |
