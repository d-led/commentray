...
| Area                                    | Gap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Dogfood `index.json`**                | The README ↔ `.commentray/source/README.md.md` pair is indexed with three `lines:` blocks and matching Markdown markers so **GitHub Pages** uses **block stretch** + index-backed scroll for that pair. Add more entries when other primaries need the same treatment.                                                                                                                                                                                                                                               |
