...
| Area                                    | Gap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Dogfood `index.json`**                | The README ↔ `.commentray/source/README.md/main.md` pair is indexed with three `lines:` blocks and matching Markdown markers; **GitHub Pages** uses dual panes + index-backed scroll (multi-angle mode skips stretch). Add more entries when other primaries need the same treatment.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- **Dogfood `index.json` (more pairs)** — When another primary gets a public Pages or editor spotlight, add `byCommentrayPath` rows + markers the same way as the README pair.
