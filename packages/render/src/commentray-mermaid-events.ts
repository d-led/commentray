/**
 * Fired from {@link ./mermaid-runtime-bootstrap.mjs} (injected by {@link ./mermaid-runtime-html.ts})
 ...
 * panes right after `load`); this event lets that work run once the module has finished its
 * `import()`.
 */
